...
|                   |      - I=2. Stock summary in output file and auxiliary files 2 through 10 are produced <br />         |
|                   |        *Note: Option flag is not compatible with `AGEPRO VERSION 4.0` format*                         |
|                   |      - I=3. Stock summary in output file and all auxiliary files are produced <br />                  |
|                   |        *Note: Option flag is not compatible with `AGEPRO VERSION 4.0` format*                         |
